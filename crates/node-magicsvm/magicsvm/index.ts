...
/**
 * The main class in the magicsvm library.
 *
 * Use this to send transactions, query accounts and configure the runtime.
 */
export class MagicSVM {
	/** Create a new MagicSVM instance with standard functionality enabled */
	...
	/** Create a new MagicSVM instance with minimal functionality enabled */
	 ...
	 * @returns The modified MagicSVM instance
	 */
	 ...
	 * Since MagicSVM doesn't have blocks, this is an arbitrary value controlled by MagicSVM
	 ...
	 * the latest blockhash from the MagicSVM instance.
	 */
