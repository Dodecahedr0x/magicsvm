...
import { ComputeBudget, MagicSVM } from "../magicsvm";
...
export const setComputeUnitLimit = (svm: MagicSVM, computeUnitLimit: bigint) => {
	const computeBudget = new ComputeBudget();
	computeBudget.computeUnitLimit = computeUnitLimit;
	return svm.withComputeBudget(computeBudget);
};

export const setHelloWorldProgram = (svm: MagicSVM, programAddress: Address) =>
